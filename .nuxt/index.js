...
import nuxt_plugin_nuxticons_3532f5fa from 'nuxt_plugin_nuxticons_3532f5fa' // Source: ./nuxt-icons.js (mode: 'all')
...
import nuxt_plugin_nativewebsocket_d560a8f6 from 'nuxt_plugin_nativewebsocket_d560a8f6' // Source: ../plugins/native-websocket (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_nuxticons_3532f5fa === 'function') {
    await nuxt_plugin_nuxticons_3532f5fa(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_vuevisjs_35f28049 === 'function') {
    await nuxt_plugin_vuevisjs_35f28049(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_vueapexchart_c7fc7154 === 'function') {
    await nuxt_plugin_vueapexchart_c7fc7154(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_nativewebsocket_d560a8f6 === 'function') {
    await nuxt_plugin_nativewebsocket_d560a8f6(app.context, inject)
  }
